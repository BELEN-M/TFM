...
-----------------------------------------------------------------------------------------------------------------------------
Resumen de los pasos ejecutados en el pipeline para el análisis de metilación de ADN (Illumina EPIC methylation 850K array). Código extraído del TFM "IDENTIFICATION OF BIOMARKERS BASED ON DNA
METHYLATION FOR DIAGNOSIS AND PROGNOSIS OF NEONATAL SEPSIS" de Paula Navarrete López.
